...
import 'package:aurora_student/cubits/downloadFileCubit.dart';

import 'package:aurora_student/data/models/studyMaterial.dart';
import 'package:aurora_student/data/repositories/subjectRepository.dart';

import 'package:aurora_student/ui/widgets/downloadFileBottomsheetContainer.dart';
import 'package:aurora_student/ui/widgets/errorMessageOverlayContainer.dart';
...
//key for globle navigation
  ...
  // }
  static Icon getBackButtonPath(BuildContext context) {
    return Directionality.of(context).name == TextDirection.rtl.name
